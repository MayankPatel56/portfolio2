...
const Footer = async () => {
    const repoStats = await fetch(
        'https://api.github.com/repos/mayankpatel/portfolio-2.0',
        {
            next: {
    ...
    return (
        <footer className="text-center pb-5" id="contact">
            <div className="container">
                ...
                <div className="">
                    <a
                        href="https://github.com/mayankpatel/portfolio-2.0"
                        target="_blank"
                        className="leading-none text-muted-foreground hover:underline hover:text-white"
                    >
                        Design & built by Mayank Patel
